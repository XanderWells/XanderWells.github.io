...
const ThumbnailTemplate = (props) => {
    ...
    // const link = (props.link) ? props.link : `/projects/${props.title.toLowerCase().replaceAll(' ','')}`
        ...
        <div className="bg-gray-900 md:rounded lg:rounded-md mb-4 lg:mb-8 p-4 lg:p-8 shadow-lg shadow-gray-900">
            ...
            <div className="flex flex-col-reverse lg:flex-row justify-center">
                <div className="lg:w-1/2 lg:mr-4 flex flex-col justify-between">
                    ...
                    <Link className="self-center lg:self-start max-w-xs w-full" to={link}>
...
ThumbnailTemplate.defaultProps = {
