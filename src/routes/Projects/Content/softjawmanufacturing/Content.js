...
const Content = () => {
    return (
        <div>
            ...
            <ImageWithCaption image={jaw8} caption="I accomplished this by painting on feature surfaces using a paint marker. By painting on the jaw, I can see which surfaces came into contact with the vice, as seen in the top left jaw. Later, I repeated this process but painted the vice instead, as seen in the bottom right jaw. There wasn't a solid need to switch the surface - I did this mainly to learn what would happen. I did this process enough times with both homemade and purchased jaws until I was confident in my tolerances."/>
            <HR />
            ...
            <HR />
            <ImageWithCaption image={jaw9} caption="After finishing Op1 for all parts on the 5-axis, I used a drill-tap machine at max rapids, etc (HAAS DT-1) to quickly finish Op2 for each part."/>
            ...
            <HR />
            <H3 className="text-center">I made lots of chips during the production run, which required some hefty cleanup at the end... Here are some examples that I liked:</H3>
